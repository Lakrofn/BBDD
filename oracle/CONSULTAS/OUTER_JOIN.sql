...
-- 11
SELECT * FROM EMPLEADO E LEFT JOIN DEPARTAMENTO D ON E.ID_DEPARTAMENTO = D.ID ORDER BY E.ID ASC;

-- 12
SELECT * FROM EMPLEADO E LEFT JOIN DEPARTAMENTO D ON E.ID_DEPARTAMENTO = D.ID WHERE E.ID_DEPARTAMENTO IS NULL ORDER BY E.ID ASC;
