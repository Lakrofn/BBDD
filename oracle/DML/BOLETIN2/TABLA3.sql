...
(
	...
	CONSTRAINT FK2_EMPLEADO FOREIGN KEY (CODIGO_EMPLEADO) REFERENCES EMPLEADO(CODIGO_EMPLEADO),
	CONSTRAINT FK3_EMPLEADO FOREIGN KEY (CODIGO_JEFE) REFERENCES EMPLEADO(CODIGO_EMPLEADO)
);
